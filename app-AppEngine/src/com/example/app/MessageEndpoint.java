 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "example.com", ownerName = "example.com", packagePath="app"))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "annular-weaver-484";
